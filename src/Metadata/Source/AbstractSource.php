...
use Zend\Db\Metadata\Object as MetadataObject;
...
abstract class AbstractSource implements MetadataInterface
{
    ...
    public function getTable($tableName, $schema = null)
    {
        ...
        switch ($data['table_type']) {
            case 'BASE TABLE':
                $table = new MetadataObject\TableObject($tableName);
                break;
            case 'VIEW':
                $table = new MetadataObject\ViewObject($tableName);
    ...
    public function getConstraintKeys($constraint, $table, $schema = null)
    {
        ...
        foreach ($this->data['constraint_keys'][$schema] as $constraintKeyInfo) {
            if ($constraintKeyInfo['table_name'] == $table && $constraintKeyInfo['constraint_name'] === $constraint) {
                $keys[] = $key = new MetadataObject\ConstraintKeyObject($constraintKeyInfo['column_name']);
    ...
    public function getTrigger($triggerName, $schema = null)
    {
        ...
        $trigger = new MetadataObject\TriggerObject();
